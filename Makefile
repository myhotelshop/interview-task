...
unit-test: ## Unit Testing
	@docker exec -it web_container ./bin/phpunit -v --colors=always ./tests/unit/service

.PHONY: api-test
api-test: ## API Testing
	@./bin/phpunit -v --colors=always ./tests/unit/controller/TrackingControllerTest.php
